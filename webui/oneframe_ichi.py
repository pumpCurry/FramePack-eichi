...
# --- 進捗バー: 共通モジュールから読み込み ---
# テーマ/色/スピナー対応は eichi_utils.progress_bar に集約済み。
# ローカル名 _make_simple_bar / _parse_bar_tag / make_progress_bar_html2 は
# 後方互換のためにここで再エクスポートする。
from eichi_utils.progress_bar import (          # noqa: E402
    make_simple_bar  as _make_simple_bar,
    parse_bar_tag    as _parse_bar_tag,
    make_progress_bar_html2,
)
