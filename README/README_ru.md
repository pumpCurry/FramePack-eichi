...
**FramePack-eichi v1.9.5** приносит ряд улучшений UI/UX и более понятный процесс запуска.

### 🚀 Основные нововведения

- Отображение имени файла и сообщения о запуске со спиннерами между импортами
- Локализация текста спиннера и логов
- Кнопка «stop-after-current» и интеграция с F1
- Расширенная очередь эталонных изображений и управление количеством батчей
- Добавлено отображение времени прогресса
- Опция сохранения входных изображений и управление избранными настройками
- Постоянный кэш подсказок и переключаемый кэш состояния LoRA
