            ...
            if has_lora_support:
                with gr.Group() as lora_settings_group:
                    ...
                    with gr.Group(visible=False) as lora_dropdown_group:
                        ...
                        lora_dropdown1 = gr.Dropdown(label=translate("LoRA1"), choices=lora_choices1, value=lora1_val, allow_custom_value=False)
                        lora_dropdown2 = gr.Dropdown(label=translate("LoRA2"), choices=lora_choices2, value=lora2_val, allow_custom_value=False)
                        lora_dropdown3 = gr.Dropdown(label=translate("LoRA3"), choices=lora_choices3, value=lora3_val, allow_custom_value=False)
